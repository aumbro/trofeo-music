...
### 🎬 โหมดวิดีโอ (เล่นไฟล์ลงจอ)

เมนู **โหมดวิดีโอ → เลือกไฟล์วิดีโอ...** (mp4/mkv/mov/webm) แล้วเล่นวนบนจอแทน visualizer
เพราะ SMTC ให้แค่ metadata (ดึงเฟรมจาก Spotify/YouTube ตรง ๆ ไม่ได้) จึงเล่นไฟล์ local เอง

จอกว้างแบน **1920×462** (~4.16:1) → เลือกการจัดเฟรมได้:
- **คลิปกลาง (band)** — เต็มจอแบบ cinematic (ตัดหัว-ท้ายคลิป)
- **ย่อทั้งคลิป (fit)** — เห็นครบ มีแถบดำซ้าย-ขวา
...
### 🕰️ โหมดนาฬิกา (14 สไตล์ เน้นวินเทจ)
...
| **กลไก** | เฟืองขบกันจริงตามอัตราทด + escapement + จักร hairspring | | |
| **ตะวัน** | ท้องฟ้าไล่สีตามเวลาจริง + ตะวัน/จันทร์โคจร + ดาว | | |
